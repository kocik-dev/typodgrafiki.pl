...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="portfolio" class="clearfix bg-white portfolio">
            <h1>Portfolio</h1>

            <article id="pupil" class="row-portfolio">
                <div class="left-row webdesign animate left-animate">
                      <img class="img-responsive" src="../images/portfolio/typodgrafiki-projekt-sklepu-pupil.png" width="453" height="271" alt="Pupil - projekt sklepu" title="Pupil - projekt sklepu">
                </div>
            ...
            <article id="rosenthal" class="row-portfolio">
                <div class="left-row webdesign animate left-animate">
                      <img class="img-responsive" src="../images/portfolio/typodgrafiki-szablon-sklepu-rosenthal.png" width="453" height="271" alt="Rosenthal - szablon sklepu" title="Rosenthal - szablon sklepu">
                </div>
                <div class="content animate right-animate">
                    <div class="flex2">
            ...
            <article id="geo-somatic" class="row-portfolio dark id-6">
                <div class="left-row animate left-animate">
                      <img class="img-responsive" src="../images/portfolio/typodgrafiki-kroj-pisma-geo-somatic.jpg" width="900" height="431" alt="GEO SOMATIC - krój pisma" title="GEO SOMATIC - krój pisma">
                </div>
                <div class="content animate right-animate">
                    <div class="flex2">
            ...
            <article id="mountain" class="row-portfolio">
                <div class="left-row webdesign animate left-animate">
                      <img class="img-responsive" src="../images/portfolio/typodgrafiki-mountain-bag-projekt-sklepu.png" width="453" height="271" alt="Mountain Bag - projekt sklepu" title="Mountain Bag - projekt sklepu">
                </div>
                <div class="content animate right-animate">
                    <div class="flex2">
            ...
            <article id="sincere-feelings" class="row-portfolio dark id-4">
                <div class="left-row animate left-animate">
                      <img class="img-responsive" src="../images/portfolio/typodgrafiki-sincere-feelings-nowa-marka-wina.jpg" width="639" height="476" alt="Sincere feelings - nowa marka wina" title="Sincere feelings - nowa marka wina">
                </div>
                <div class="content animate right-animate">
                    <div class="flex2">
            ...
            <article id="premium-sound" class="row-portfolio">
                <div class="left-row webdesign animate left-animate">
                      <img class="img-responsive" src="../images/portfolio/typodgrafiki-premium-sound-szablon-sklepu.png" width="453" height="271" alt="Premium Sound - szablon sklepu" title="Premium Sound - szablon sklepu">
                </div>
                <div class="content animate right-animate">
                    <div class="flex2">
            ...
            <article id="bulkibezbibulki" class="row-portfolio">
                <div class="left-row webdesign animate left-animate">
                      <img class="img-responsive" src="../images/portfolio/typodgrafiki-bulkibezbibulki-blog.png" width="453" height="271" alt="Bułki bez bibułki - blog" title="Bułki bez bibułki - blog">
                </div>
                <div class="content animate right-animate">
                    <div class="flex2">
            ...
            <article id="audio-mix" class="row-portfolio">
                <div class="left-row webdesign animate left-animate">
                      <img class="img-responsive" src="../images/portfolio/typodgrafiki-audio-mix-szablon-sklepu.png" width="453" height="271" alt="Audio-Mix - szablon sklepu" title="Audio-Mix - szablon sklepu">
                </div>
                <div class="content animate right-animate">
                    <div class="flex2">
