...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="portfolio-show" class="clearfix bg-white portfolio text-center">
            ...
            <div class="bg-dark">
                <img class="img-responsive visible-md" src="<?php echo BASE_PATH ?>images/portfolio/sincere-feelings/sf_01.jpg" width="1400" height="1198" alt="SF1">
                <img class="img-responsive hidden-md" src="<?php echo BASE_PATH ?>images/portfolio/sincere-feelings/mobile/sf_01_xs.jpg" width="900" height="761" alt="SF1">
            </div>
            ...
            <div class="bg-gray logo2 clearfix">
                <div class="container">
                    <div class="col-xs-12 col-sm-6 animate left-animate">
                        <img class="img-responsive" src="<?php echo BASE_PATH ?>images/portfolio/sincere-feelings/sf_03.png" width="529" height="169" alt="SF3">
                    </div>
                    <div class="col-xs-12 col-sm-6 animate right-animate">
                        <img class="img-responsive" src="<?php echo BASE_PATH ?>images/portfolio/sincere-feelings/sf_04.png" width="529" height="169" alt="SF4">
                    </div>
                </div>
            </div>
            <div class="bg-dark clearfix">
                <div class="col-xs-12 col-sm-6">
                    <img class="img-responsive" src="<?php echo BASE_PATH ?>images/portfolio/sincere-feelings/sf_05.jpg" width="950" height="1098" alt="SF5">
                </div>
                <div class="col-xs-12 col-sm-6">
                    <img class="img-responsive" src="<?php echo BASE_PATH ?>images/portfolio/sincere-feelings/sf_06.jpg" width="950" height="1098" alt="SF6">
                </div>
            </div>
            <div class="box-draw">
                <img class="img-responsive animate right-animate visible-md" src="<?php echo BASE_PATH ?>images/portfolio/sincere-feelings/sf_07.png" width="1400" height="1015" alt="SF7">
                <img class="img-responsive animate right-animate hidden-md" src="<?php echo BASE_PATH ?>images/portfolio/sincere-feelings/mobile/sf_07_xs.png" width="900" height="652" alt="SF7">
            </div>
            ...
            <div class="bg-dark clearfix">
                <img class="img-responsive visible-md" src="<?php echo BASE_PATH ?>images/portfolio/sincere-feelings/sf_13.jpg" width="1400" height="1338" alt="SF13">
                <img class="img-responsive visible-md" src="<?php echo BASE_PATH ?>images/portfolio/sincere-feelings/sf_14.jpg" width="1400" height="1338" alt="SF14">

                <img class="img-responsive hidden-md" src="<?php echo BASE_PATH ?>images/portfolio/sincere-feelings/mobile/sf_13_xs.jpg" width="900" height="860" alt="SF13">
                <img class="img-responsive hidden-md" src="<?php echo BASE_PATH ?>images/portfolio/sincere-feelings/mobile/sf_14_xs.jpg" width="900" height="860" alt="SF14">
            </div>
            <div class="bg-gray leaflet">
                <img class="img-responsive" src="<?php echo BASE_PATH ?>images/portfolio/sincere-feelings/sf_15.jpg" width="921" height="1744" alt="SF15">
            </div>
